 ...
 */
public class LigneAvisEcheanceAdapter extends ArrayAdapter<LigneAvisEcheanceDTO> {

    public LigneAvisEcheanceAdapter(Context context, ArrayList<LigneAvisEcheanceDTO> lignes) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LigneAvisEcheanceDTO ligneBL = getItem(position);

        // Check if an existing view is being reused, otherwise inflate the view
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.ligne_avis_echeance_liste_item, parent, false);
        }
