...
public class AvisEcheanceDTO implements Serializable, IDocumentDTO {
    ...
    private List<LigneAvisEcheanceDTO> lignesDTO = null;
...
//    }
    ...
    public void regroupeLigne() {
        if(lignesDTO!=null) {
            Map<String, LigneAvisEcheanceDTO> mapNumlotLigneBl = new HashMap<>();
            List<LigneAvisEcheanceDTO> ligneSansNumLot = new ArrayList<>();
            String cle_codeBarreNumLot = "";
            for (LigneAvisEcheanceDTO l : lignesDTO) {
                if(l.getNumLot()!=null) {
            ...
            lignesDTO.clear();
            for (LigneAvisEcheanceDTO l : mapNumlotLigneBl.values()) {
                lignesDTO.add(l);
            }
            lignesDTO.addAll(ligneSansNumLot);

            //tri en fonction du libellé
            Collections.sort(lignesDTO, new Comparator<LigneAvisEcheanceDTO>() {
                @Override
                public int compare(LigneAvisEcheanceDTO l1, LigneAvisEcheanceDTO l2) {
...
//                    }
    ...
    @JsonProperty("lignesDTO")
    public List<LigneAvisEcheanceDTO> getLignesDTO() {
        return lignesDTO;
    }

    @JsonProperty("lignesDTO")
    public void setLignesDTO(List<LigneAvisEcheanceDTO> lignesDTO) {
